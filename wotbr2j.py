...
VEH_INTERACTION_DETAILS = (('spotted', 'B', 1, 0), ('deathReason', 'b', 10, -1), ('hits', 'H', 65535, 0),
                           ('he_hits', 'H', 65535, 0), ('pierced', 'H', 65535, 0), ('damageDealt', 'H', 65535, 0),
                           ('damageAssistedTrack', 'H', 65535, 0), ('damageAssistedRadio', 'H', 65535, 0),
                           ('crits', 'I', 4294967295L, 0), ('fire', 'H', 65535, 0))
...
def convertToFullForm(compactForm):
    ...
    try:
        fullForm = {'arenaUniqueID': compactForm[0], 'personal': listToDict(VEH_FULL_RESULTS, compactForm[1]),
                    'common': {}, 'players': {}, 'vehicles': {}}
